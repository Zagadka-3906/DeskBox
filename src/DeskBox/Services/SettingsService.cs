    ...
    internal static IReadOnlyDictionary<string, DefaultPreferencePreservationReason>
        DefaultPreferencePreservationPolicy { get; } =
            new Dictionary<string, DefaultPreferencePreservationReason>(StringComparer.Ordinal)
            {
                ...
                [nameof(AppSettings.DormElectricityClient)] = DefaultPreferencePreservationReason.UserChoice,
                [nameof(AppSettings.DormElectricityBuildingId)] = DefaultPreferencePreservationReason.UserChoice,
                [nameof(AppSettings.DormElectricityBuildingName)] = DefaultPreferencePreservationReason.UserChoice,
                [nameof(AppSettings.DormElectricityFloorId)] = DefaultPreferencePreservationReason.UserChoice,
                [nameof(AppSettings.DormElectricityRoomId)] = DefaultPreferencePreservationReason.UserChoice,
                [nameof(AppSettings.DormElectricityRoomName)] = DefaultPreferencePreservationReason.UserChoice,
                [nameof(AppSettings.DormElectricityUsagePeriod)] = DefaultPreferencePreservationReason.UserChoice,
                [nameof(AppSettings.DormElectricityPaymentPeriod)] = DefaultPreferencePreservationReason.UserChoice,
                [nameof(AppSettings.DormElectricityServerChanDailyEnabled)] = DefaultPreferencePreservationReason.UserChoice,
                [nameof(AppSettings.DormElectricityServerChanLowEnabled)] = DefaultPreferencePreservationReason.UserChoice,
                [nameof(AppSettings.DormElectricityServerChanHour)] = DefaultPreferencePreservationReason.UserChoice,
                [nameof(AppSettings.DormElectricityServerChanMinute)] = DefaultPreferencePreservationReason.UserChoice,
                [nameof(AppSettings.DormElectricityServerChanLowThresholdKwh)] = DefaultPreferencePreservationReason.UserChoice,
                [nameof(AppSettings.DormElectricityServerChanLastDailyStamp)] = DefaultPreferencePreservationReason.RuntimeState,
                [nameof(AppSettings.DormElectricityServerChanLastLowStamp)] = DefaultPreferencePreservationReason.RuntimeState,
